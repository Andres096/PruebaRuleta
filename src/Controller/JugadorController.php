...
class JugadorController extends AbstractController
{
    ...
    {
        return $this->render('jugador/index.html.twig', ['jugadors' => $jugadorRepository->findAll()]);
    }
    ...
    {
        return $this->render('jugador/show.html.twig', ['jugador' => $jugador]);
    }
    ...
    public function edit(Request $request, Jugador $jugador): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('jugador_index', ['id' => $jugador->getId()]);
        }
